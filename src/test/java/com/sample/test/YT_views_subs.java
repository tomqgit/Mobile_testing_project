...
public class YT_views_subs {
	...
	public static void get_YT_details(String channel_name) throws InterruptedException {
		...
		driver.findElement(By.xpath(".(//div[@class='tab-content style-scope tp-yt-paper-tab'])[last()]")).click();
		Thread.sleep(5000);
		System.out.println(driver.findElement(By.xpath(".//yt-formatted-string[@class='style-scope ytd-channel-about-metadata-renderer'][contains(text(),'views')]")).getText());
